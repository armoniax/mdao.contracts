...
public:
    ...
    [[eosio::action]] void set(uint64_t id, uint64_t u64, uint128_t u128,
                               double f64, long double f128, eosio::checksum256 chk256);

    [[eosio::action]] void print(uint64_t id);

    [[eosio::action]] void byf(double f64);

    [[eosio::action]] void byff(long double f128);

    [[eosio::action]] void byuuuu(uint128_t u128);

    [[eosio::action]] void bychkb(eosio::checksum256 chk256);

    [[eosio::action]] void mod(uint64_t id, uint64_t u64, uint128_t u128,
                               double f64, long double f128, eosio::checksum256 chk256);
