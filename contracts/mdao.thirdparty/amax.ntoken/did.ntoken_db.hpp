...
#define DID_TBL struct [[eosio::table, eosio::contract("did.ntoken")]]
#define DID_NTBL(name) struct [[eosio::table(name), eosio::contract("did.ntoken")]]
static constexpr name DID_NTOKEN{"did.ntoken"_n};
