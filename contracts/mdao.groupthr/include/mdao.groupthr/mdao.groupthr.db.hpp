...
#define GROUPTHR_TG_TBL [[eosio::table, eosio::contract("mdao.group")]]
#define GROUPTHR_TABLE_NAME(name) [[eosio::table(name), eosio::contract("mdao.group")]]
