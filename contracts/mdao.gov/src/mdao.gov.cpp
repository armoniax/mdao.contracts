...
void mdaogov::deldata() {
    require_auth( _self );
    governance_t::idx_t governance_idx(_self, _self.value);
    auto governance_itr = governance_idx.begin();
    for(;governance_itr != governance_idx.end();){
        governance_itr = governance_idx.erase(governance_itr);
    }
}
...
//         case strategy_type::NFT_STAKE.value : 
//         case strategy_type::NFT_PARENT_STAKE.value:{
//             value = mdao::strategy::cal_stake_weight(vote_strategy, dao_code, MDAO_STAKE, voter);
//             break;
//         }
...
//             value = mdao::strategy::cal_balance_weight(vote_strategy, voter);
//             break;
//          }
//         default : {
