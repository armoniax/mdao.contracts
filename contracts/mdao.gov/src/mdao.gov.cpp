...
{    
    ...
    CHECKC( vote_strategy->type == strategy_status::published && propose_strategy->type == strategy_status::published, 
            gov_err::STRATEGY_TYPE_ERROR, "strateg·y type must be published" );
