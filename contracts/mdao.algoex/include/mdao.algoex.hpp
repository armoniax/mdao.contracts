...
class [[eosio::contract("mdao.algoex")]] algoex : public contract
{
private:
    algoex_global_singleton    _global;
    algoex_global_t            _gstate;
    dbc           _db;
